        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <button
              ...
              className="p-2 rounded-lg hover:bg-secondry transition-colors"
            >
            ...
            <div className="flex-1 flex justify-center">
              <h1 className="text-2xl font-bold  text-primary">SmartCart</h1>
            </div>
            ...
            <div className="flex item-center space-x-2">
              ...
              <button
                ...
                className="relative p-2 rounded-lg hover:bg-secondry transition-colors"
              >

  ...
  return (
    <>
      ...
      <div className="fixed left-0 top-0 h-full w-80 z-50 glass-panel animate-slide-in-left">
        <div className="flex item-center justify-between p-6 border-b border-[hsla(var(--glass-border))]">
              ...
              return (
                <li key={item.name}>
                  <Link
                    to={item.path}
                    onClick={() => dispatch(toggleSidebar())}
                    className="flex item-center space-x-3 p-3 rounded-lg glass-card hover:glow-on-hover animate-smooth text-forground hover:text-primary group"
                  >

...
const LoginModal = () => {
  ...
  //detect reset password url and popup with reset mode
        ...
        <div className="relative z-10 glass-panel w-full max-w-md mx-4 animate-fade-in-up">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="p-2 rounded-lg glass-cart hover:glow-on-hover animate-smooth"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {mode !== "reset" && (
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-muted-forefround" />
                <input
                  type="email"
            ...
            {mode !== "forgot" && (
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-muted-forefround" />
                <input
                  type="password"
            ...
            {mode === "reset" && (
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 text-muted-forefround" />
                <input
                  type="password"
            ...
            {mode === "signin" && (
              <div className="text-right text-sm">
                <button
                  ...
                  className="text-primary hovr:text-accent animate-smooth"
                >
                  Forgot Password?
                </button>
              </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full py-3 gradient-primary flex justify-center utems-center gap-2 text-primary-foreground rounded-lg font-semibold animate-smooth ${isLoading ? "opacity-70 cursor-not-allowed" : "hover:glow-on-hover"}`}
            >
              {isLoading ? (
                <>

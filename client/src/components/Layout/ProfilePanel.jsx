...
const ProfilePanel = () => {
  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-96 z-50 glass-panel animate-slide-in-right overflow-auto">
          ...
          {authUser && (
            <div className="space-y-4 mb-8">
              ...
              <button
                ...
                className="flex justify-center item-center space-x-3 p-3 rounded-lg glass-card hover:glow-on-hover animate-smooth group w-full"
              >
                {isUpdatingProfile ? (
                  <>
                    <div
                      className={`w-5 h-5 order-2 border-white border-t-transparent rounded-full animate-spin`}
                    />
